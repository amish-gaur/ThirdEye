...
- **Action router (Person 2):** [`action_router/README.md`](action_router/README.md) ← _this branch_
...
| `vision-pipeline` | Amish | YOLO trigger + rolling buffer + Moondream classifier |
